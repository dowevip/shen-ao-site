...
export type Project = {
  ...
  verificationStatus: "confirmed" | "archive-only" | "later-verification";
};
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Interdisciplinary improvisation practice.",
    externalLinks: [
  ...
  { slug: "douyin-cultural-promo", title: "Douyin Cultural Product Promo", category: "Moving Image", verificationStatus: "archive-only" },
  { slug: "zhang-jian-jingdezhen", title: "Zhang Jian and Jingdezhen", category: "Moving Image", verificationStatus: "archive-only" },
  { slug: "iqiyi-vr-se", title: "iQIYI VR SE Promo", category: "Moving Image", verificationStatus: "archive-only" },
  { slug: "mr-monster-resource", title: "Mr.Monster Resource", category: "Cross-media", verificationStatus: "archive-only" },
  { slug: "the-back-door-of-stage", title: "the back door of stage", category: "Cross-media", verificationStatus: "archive-only" },
  { slug: "tunnel", title: "Tunnel", category: "Cross-media", subtype: "Moving Image", verificationStatus: "archive-only" }
];
